...
import { editableProfileCardReducer } from '../../model/slices/editableProfileCardSlice/editableProfileCardSlice';
...
describe('EditableProfileCard test', () => {
    ...
    test('the error case', async () => {
        ...
        expect(
            screen.getByTestId('EditableProfileCard.ErrorParagraph'),
        ).toBeInTheDocument();
    });
